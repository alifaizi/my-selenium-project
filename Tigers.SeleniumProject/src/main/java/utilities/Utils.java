...
public class Utils {
	...
	// by calling the below method, we will be able to close the current browser or
	// browsers opened by selenium
	// close() => we use close() method to close only one browser that is opened by
	// selenium
	// quit() => we use quit() method to close all browsers opened by selenium
	// With selenium, we can open either one or more than one window to execute our
	// test, we will practice with multiple
	// browsers in the second week of selenium when we get to the windowHandle and
	// windowsHanlde
